/**
 * @ developer: theyt
 * @ origin source: https://www.theyt.net/wiki/한영타변환기
 */
...
function doConvert() {
	const srcElem = document.getElementById("txtSource");
	const destElem = document.getElementById("txtConv");

	if (optEtoH.checked) {
		destElem.value = engTypeToKor(srcElem.value);
	} else {
		destElem.value = korTypeToEng(srcElem.value);
	}
}
